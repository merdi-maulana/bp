...
import gerbang from "@/public/images/gerbang.webp";
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full mt-10 md:mt-0">
        <div className="flex flex-col gap-6 max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-tight text-white drop-shadow-lg">
            Hunian Asri untuk Masa Depan{" "}
            <span className="text-[#92F7C3] italic">Berkualitas.</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-xl drop-shadow-md">
            Wujudkan impian memiliki rumah dengan konsep nature-living yang
            terjangkau. DP ringan, cicilan mulai Rp 1 juta-an/bulan.
          </p>
